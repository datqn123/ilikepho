...
- [x] **DoD-04**: `mvn -q compile` và toàn bộ unit test không bị ảnh hưởng (pass). *(Chạy: `./mvnw -q compile` exit 0; `./mvnw test` → **Tests run: 71, Failures: 0, Errors: 0 — BUILD SUCCESS**, tăng từ 56 test của Task 06.)*
